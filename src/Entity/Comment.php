 ...
 *     }
 * )
 * Filtrer pour récupérer les commentaires associés à un post précis
...
class Comment
{
     ...
     * Autorisé a faire la modification du Post lors d'une création (create:comment)
     ...
     * )
     * Lorsqu'on modifie un commentaire, on est autorisé à le faire lors de la création(create:comment) et de la modification (update:comment)
